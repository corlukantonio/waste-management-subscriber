...
class MqttHandler {
   ...
   * @type {string}
   */
  #url = process.env.WMS_MQTT_BROKER_URL;
  ...
  #client = mqtt.connect(this.#url, {
    clean: true,
    port: process.env.WMS_MQTT_BROKER_PORT,
    username: process.env.WMS_MQTT_BROKER_USER,
    password: process.env.WMS_MQTT_BROKER_PASSWORD,
  });
